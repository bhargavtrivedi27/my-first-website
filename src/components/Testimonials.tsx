  ...
  const testimonials = [
    {
      ...
      name: "Sarah Martinez",
      location: "Phoenix, AZ",
      message: "TreatConnect helped me find an excellent cardiologist when I moved to a new city. The booking process was seamless, and the doctor was exactly what I needed. Highly recommend!",
    ...
    },
    {
      ...
      name: "Robert Johnson",
      location: "Atlanta, GA",
      message: "As a senior, I was worried about using online healthcare platforms. TreatConnect made it so simple! I found a great primary care doctor and the staff helped me every step of the way.",
    ...
    },
    {
      ...
      name: "Dr. Emily Chen",
      location: "Seattle, WA",
      message: "As both a healthcare provider and patient, I love TreatConnect's approach. The platform connects patients with quality care while making the process efficient for providers too.",
    ...
    },
    {
      ...
      location: "Miami, FL",
      message: "Managing healthcare for my elderly parents became so much easier with TreatConnect. I can book their appointments, track their care, and ensure they get the attention they deserve.",
    ...
    },
    {
      ...
      location: "Denver, CO",
      message: "TreatConnect saved me when I needed urgent care while traveling for business. Found a great urgent care clinic, got seen quickly, and the follow-up care coordination was excellent.",
